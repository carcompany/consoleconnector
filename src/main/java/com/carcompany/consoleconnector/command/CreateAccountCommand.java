		...
		switch (CredentialEnumeration.valueOf(credentialType)) {
			case PASSWORD:
				...
				do {
					...
					password = console.ask4Input("Please enter a password for your new account.");

					password2 = console.ask4Input("Please repeat the entered password.");
				...
				account = CarReservationServiceObservable.getInstance().createAccount(person, CredentialEnumeration.PASSWORD, password, PaymentType.valueOf(arguments[1]));
